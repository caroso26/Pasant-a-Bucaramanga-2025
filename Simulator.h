#ifndef CosmicSimulator_h
#define CosmicSimulator_h 1
...
class CosmicSimulator 
{
	public:
		...
		static CosmicSimulator* fCosmicSimulator;
	...
	private:
		...
		friend class CosmicDetectorConstructor;
		friend class CosmicPrimaryGenerator;
};
