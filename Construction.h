// definition of the CosmicConstruction class
#ifndef CosmicConstruction_h
#define CosmicConstruction_h 1
...
class CosmicConstruction : public G4VUserDetectorConstruction {
	
	public:
		CosmicConstruction(Event& theEvent);
		virtual ~CosmicConstruction();
